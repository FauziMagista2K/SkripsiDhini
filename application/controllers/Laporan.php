...
class Laporan extends CI_Controller
{
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        $pdf->Cell(250, 7, 'PT. DINAMIKA JAYA SEMESTA', 0, 1, 'C');
        //membuat garis ganda tebal dan tipis

        $pdf->SetFont('Times', '', 10);
        $pdf->Cell(250, 7, 'Tanggal : ' . $tanggal, 0, 1, 'C');
        $pdf->Ln(10);
        ...
        if ($table_ == 'barang_masuk') :
            ...
            $pdf->Cell(25, 7, 'Kode Barang', 1, 0, 'C');
            $pdf->Cell(55, 7, 'Nama Barang', 1, 0, 'C');
            $pdf->Cell(85, 7, 'Supplier', 1, 0, 'C');
            ...
            foreach ($data as $d) {
                ...
                $pdf->Cell(85, 7, $d['nama_supplier'], 1, 0, 'L');
