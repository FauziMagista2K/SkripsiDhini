...
<head>
    ...
    <title><?= $title; ?> | Sistem Inventory</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center  justify-content-center">
                <div class="sidebar-brand-icon">

                    <img src="https://dinamikajayasemesta.com/wp-content/uploads/2021/10/Logo.jpg" width="100px" height="70px" alt="">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Dhini</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
